...
static DWORD TimeFunction(boolean microseconds)
{
	DWORD newtics = 0;
	int multiplier = 1;
...
static int TimeFunction(boolean microseconds)
{
	...
	/* nanoseconds to milli- or microseconds */
	if (microseconds)
	{
...
//	static Uint64 basetime = 0;
		   Uint64 ticks = TimeFunction(false);//SDL_GetTicks();
