...
static CV_PossibleValue_t kartbenice_cons_t[] = {{0, "MIN"}, {MAXPLAYERS, "MAX"}, {0, NULL}};
consvar_t cv_kartbenice = {"kartbenice", "0", CV_SAVE, kartbenice_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
